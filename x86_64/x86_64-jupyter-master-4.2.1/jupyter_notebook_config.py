...
c.NotebookApp.certfile = u'/usr/local/share/jupyter/certs/pc-core-jupyter.pem'
...
c.NotebookApp.keyfile = u'/usr/local/share/jupyter/certs/pc-core-jupyter.key'
...
c.NotebookApp.notebook_dir = u'/pocket/workspace'
...
c.NotebookApp.password = u'sha1:c8fca1cdf198:7ba65c842c248d063e3a799c6ab3aec2bdbc6fd1'
...
c.KernelSpecManager.whitelist = set(["pyspark"])
